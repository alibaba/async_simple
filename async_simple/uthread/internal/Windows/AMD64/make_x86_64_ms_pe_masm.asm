...
_fl_make_fcontext PROC EXPORT FRAME
    ; .xdata for a function's structured exception handling unwind behavior
    .endprolog

    ; first arg of _fl_make_fcontext() == top of context-stack
    mov  rax, rcx
    ...
    mov  [rax+0c8h], rcx
    ; second arg of _fl_make_fcontext() == size of context-stack
