...
template <Security security> class client {
public:
...
private:
  ...
  void build_smtp_content(std::ostream &out) {
    out << "Content-Type: multipart/mixed; boundary=\"async_simple\"\r\n\r\n";
...
template <Security security> auto get_client(asio::io_context &io_context) {
