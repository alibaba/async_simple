...
namespace detail {
export template <typename LazyType, typename IAlloc, typename OAlloc, bool Para>
struct CollectAllAwaiter;

export template <typename LazyType, typename IAlloc>
...
public:
    ...
    struct TryAwaiter : public AwaiterBase {
        ...
        inline __attribute__((__always_inline__)) Try<T> await_resume() noexcept {
...
// to a deadlock.
export template <typename LazyType>
