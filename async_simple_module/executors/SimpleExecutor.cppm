...
module;
#include <cassert>
export module async_simple:executors.SimpleExecutor;

import :Executor;
import :IOExecutor;
import :executors.SimpleIOExecutor;
...
// want to have fun with future lite could use SimpleExecutor for convenience,
...
public:
    ...
    std::size_t currentContextId() const override { return _pool.getCurrentId(); }
